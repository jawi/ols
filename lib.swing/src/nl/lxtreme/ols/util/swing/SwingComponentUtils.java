...
import nl.lxtreme.ols.util.swing.StandardActionFactory.CancelAction;
import nl.lxtreme.ols.util.swing.StandardActionFactory.CloseAction;
import nl.lxtreme.ols.util.swing.StandardActionFactory.OkAction;
...
public final class SwingComponentUtils
{
   ...
   */
  public static File setFileExtension( File aFile, String aFileExtension )
  {
   ...
   *         but can be empty if the given file has <em>no</em> file extension.
   */
  public static  String[] stripFileExtension( File aFile, String... aExtensions )
  {
   ...
   *         but can be empty if the given file has <em>no</em> file extension.
   */
  public static  String[] stripFileExtension( String aFilename, String... aExtensions )
  {
