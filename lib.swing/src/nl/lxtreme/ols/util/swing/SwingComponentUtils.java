...
public final class SwingComponentUtils
{
  ...
  private static final int BUTTONS_PADDING_TOP = 4;
  private static final int BUTTONS_PADDING_BOTTOM = 4;
      ...
      final Component aButtonPane, final JButton defaultButton )
  {
    ...
    contentPane.setBorder( BorderFactory.createEmptyBorder( 0, DIALOG_PADDING, //
        DIALOG_PADDING, DIALOG_PADDING ) );

    final JPanel centerPane = new JPanel( new BorderLayout() );
    centerPane.add( aCenterComponent, BorderLayout.CENTER );
    centerPane.setBorder( BorderFactory.createEmptyBorder( DIALOG_PADDING, 0, //
        2 * DIALOG_PADDING, 0 ) );
