...
/**
 * Denotes a testing device that outputs static (generated) data.
 */
public class TestDevice implements Device
{
   ...
   */
  public TestDevice( final TestDeviceDialog aConfigDialog, final AcquisitionProgressListener aProgressListener )
  {
