...
public final class ResourceUtils
{
  ...
  /**
   * Returns the resource with the given name from the same directory as the given class.
   * 
   * @param aClass
  ...
  {
    String prefix = aClass.getPackage().getName().replaceAll( "\\.", File.separator );
    return getResource( aClass, prefix, aName );
  }
