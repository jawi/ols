...
/**
 * Test cases for {@link ConnectorServiceImpl}.
 */
public class ConnectorServiceImplTest extends TestCase
{
  // INNER TYPES
   ...
   * @throws Exception
   */
  public void testCheckCorrectnessOfActivator() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenDataInputStream() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenDataOutputStream() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenString() throws Exception
  {
    final MyConnectionFactory factory1 = create( new String[] { Protocols.HTTP.protocol() }, 1 );
   ...
   * @throws Exception
   */
  public void testOpenStringCFWithTwoSchemes() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenStringFailsNoScheme() throws Exception
  {
    // wrong protocol
    ...
    try
    {
      ...
      fail( "Expected ConnectionNotFoundException!" );
    }
   ...
   * @throws Exception
   */
  public void testOpenStringFailsWrongProtocol() throws Exception
  {
    // wrong protocol
    final MyConnectionFactory factory = create( new String[] { Protocols.FTP.protocol() }, 1 );
    registerConnectionFactory( factory, "(io.schema=ftp)" );
   ...
   * @throws Exception
   */
  public void testOpenStringWithModeAndTimoutsFalse() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenStringWithModeAndTimoutsTrue() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenStringWithModeRead() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenStringWithModeReadWrite() throws Exception
  {
   ...
   * @throws Exception
   */
  public void testOpenStringWithModeWrite() throws Exception
  {
  ...
  protected void setUp()
  {
    ...
    when(
        this.context.registerService( matches( ConnectorService.class.getName() ), anyObject(),
            ( Dictionary<?, ?> )isNull() ) ).thenAnswer( csAnswer );
