 ...
 */
public class UserSettingsImplTest extends TestCase
{
  // INNER TYPES
  ...
  /**
   * Test method for
   * {@link nl.lxtreme.ols.client.data.settings.UserSettingsImpl#UserSettingsImpl(nl.lxtreme.ols.util.swing.UserSettings)}
   * .
   */
