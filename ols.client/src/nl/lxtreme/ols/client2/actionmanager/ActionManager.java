...
/**
 * Denotes a manager for {@link ManagedAction}s.
 */
public interface ActionManager
{
   ...
   *           by this manager.
   */
  ManagedAction add( ManagedAction aAction ) throws IllegalArgumentException;
   ...
   */
  ManagedAction getAction( String aId ) throws IllegalArgumentException;
   ...
   */
  ManagedAction[] getActionByType( Class<? extends ManagedAction> aActionType );
   ...
   *           this manager.
   */
  void remove( ManagedAction aAction ) throws IllegalArgumentException;
