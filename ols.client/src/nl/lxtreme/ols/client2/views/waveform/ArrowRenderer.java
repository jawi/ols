...
public class ArrowRenderer
{
  ...
  {
    if ( aWidth < 2 * HEAD_WIDTH )
    {
      // Too narrow, cannot draw the arrow heads...
      aCanvas.drawLine( 0, 0, aWidth, 0 );
      return;
    }
    ...
    drawDoubleHeadedArrow( aCanvas, 0, 0, aWidth, 0, HEAD_WIDTH, HEAD_HEIGHT );
  }
