...
/**
 * Provides a {@link AbstractManagedAction} that is used for performing file
 * I/O.
 */
public abstract class AbstractFileAction extends AbstractManagedAction
{
  // CONSTANTS
  ...
  /**
   * Creates a new {@link AbstractFileAction} instance.
   * 
   * @param aID
   *          the ID of this action, cannot be <code>null</code>.
   */
  protected AbstractFileAction( String aID )
  {
    super( aID );
  }
   ...
   */
  protected final String getFileExtension( File aFile )
  {
    String ext = "";
   ...
   */
  protected final File setFileExtension( File aFile, String aFileExtension )
  {
   ...
   *         but can be empty if the given file has <em>no</em> file extension.
   */
  protected final String[] stripFileExtension( File aFile, String... aExtensions )
  {
   ...
   *         but can be empty if the given file has <em>no</em> file extension.
   */
  protected final String[] stripFileExtension( String aFilename, String... aExtensions )
  {
