 ...
 */
public class CloseSessionAction extends AbstractManagedAction
{
  // CONSTANTS
  ...
  /**
   * Creates a new {@link CloseSessionAction} instance.
   */
  public CloseSessionAction()
  {
    super( ID );

    putValue( NAME, "Close session" );
