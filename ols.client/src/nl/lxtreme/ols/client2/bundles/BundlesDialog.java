 ...
 */
package nl.lxtreme.ols.client2.bundles;
...
/**
 * Provides a dialog showing the current set of bundles.
 */
public class BundlesDialog extends JDialog implements Closeable
{
  ...
  /**
   * Creates a new {@link BundlesDialog} instance.
   * 
   * @param aOwner
   *          the owning window, can be <code>null</code>.
   */
  public BundlesDialog( Window aOwner )
  {
    super( aOwner, "OSGi Bundles", ModalityType.MODELESS );
