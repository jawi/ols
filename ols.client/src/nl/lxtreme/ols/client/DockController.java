...
public class DockController implements IMeasurementListener
{
  ...
  volatile AnnotationOverview annotationOverview;
  ...
  public DockController( final File aDataStorage, final SignalDiagramController aSignalDiagramController )
  {
    ...
    SwingComponentUtils.invokeOnEDT( new Runnable()
    {
      ...
      public void run()
      {
        ...
        DockController.this.annotationOverview = AnnotationOverview.create( aSignalDiagramController );
  ...
  void start()
  {
    ...
    registerToolWindow( this.annotationOverview, DockController.GROUP_DEFAULT );
