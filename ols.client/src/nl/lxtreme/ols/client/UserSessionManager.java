...
public class UserSessionManager
{
  ...
  static class WindowStateListener implements AWTEventListener
  {
    ...
    private volatile ProjectController projectManager;
     ...
     */
    final void setProjectManager( final ProjectController aProjectManager )
    {
    ...
    {
      return this.projectManager.getProject().getSettings( aNamespace );
    }
    ...
    {
      this.projectManager.getProject().setSettings( aUserSettings );
    }
  }
  ...
  private volatile ProjectController projectController;
  ...
  private void loadImplicitUserSettings()
  {
    ...
    final Project currentProject = this.projectController.getProject();
    try
    {
