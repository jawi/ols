 ...
 */
package nl.lxtreme.ols.client.signaldisplay.view.channellabels;
...
import nl.lxtreme.ols.client.signaldisplay.view.DragAndDropTargetController.DragAndDropHandler;
...
public class ChannelLabelsView extends AbstractViewLayer
{
  ...
  static final class DragAndDropListener implements DragGestureListener, DragSourceMotionListener, DragSourceListener
  {
    ...
    public void dragGestureRecognized( final DragGestureEvent aEvent )
    {
      ...
      final InsertionPointRenderer renderer = new InsertionPointRenderer( model, element );
