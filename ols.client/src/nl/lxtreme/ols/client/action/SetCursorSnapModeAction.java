 ...
 */
public class SetCursorSnapModeAction extends AbstractAction implements IManagedAction
{
  // CONSTANTS
...
//    putValue( SELECTED_KEY, Boolean.valueOf( aController.getSignalDiagramModel().isSnapCursorMode() ) ); XXX
  }
