...
public class EditMarkerPropertiesAction extends AbstractAction
{
   ...
   */
  static final class EditMarkerDialog extends JDialog implements StatusAwareDialog
  {
    // CONSTANTS
  ...
  public void actionPerformed( final ActionEvent aEvent )
  {
    EditMarkerDialog dialog = new EditMarkerDialog( SwingComponentUtils.getOwningWindow( aEvent ), this.marker );
