 ...
 */
public final class StubCursorImpl implements Comparable<StubCursorImpl>, Cloneable, Cursor
{
  // VARIABLES
  ...
  /**
   * Creates a new {@link StubCursorImpl} instance.
   * 
   * @param aIndex
   ...
   */
  public StubCursorImpl( final int aIndex )
  {
   ...
   *           in case the given index was invalid.
   */
  public StubCursorImpl( final int aIndex, final long aTimestamp )
  {
    this( aIndex );
   ...
   */
  @Override
  public StubCursorImpl clone()
  {
    try
    {
      final StubCursorImpl result = ( StubCursorImpl )super.clone();
      if ( isDefined() )
      {
   ...
   */
  @Override
  public int compareTo( final StubCursorImpl aOtherCursor )
  {
  ...
  public boolean equals( final Object aObject )
  {
    ...
    final StubCursorImpl other = ( StubCursorImpl )aObject;
