 ...
 */
public class LogicSnifferRleTimingComponentTest extends TestCase
{
  // INNER TYPES
  ...
  final class RleSampleProvider implements SampleProvider
  {
    ...
    public RleSampleProvider( final int aWidth, final double aRatio, final int aMask )
    {
      ...
      this.packedHighValue = VirtualLogicSnifferDevice.packBytes( this.sampleHighValue );
      this.packedLowValue = VirtualLogicSnifferDevice.packBytes( this.sampleLowValue );
    }
