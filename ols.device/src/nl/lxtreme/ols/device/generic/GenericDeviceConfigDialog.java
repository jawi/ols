...
public class GenericDeviceConfigDialog extends JDialog implements Configurable, Closeable
{
  ...
  public int getChannelCount()
  {
    ...
    try
    {
      result = Integer.parseInt( this.channelCount.getText() );
    }
  ...
  {
    return SwingComponentUtils.smartParseInt( this.sampleDepth.getText(), 1024 );
  }
  ...
  public int getSampleRate()
  {
    ...
    try
    {
      result = Integer.parseInt( this.sampleRate.getText() );
    }
    catch ( NumberFormatException exception )
    {
      result = 10000;
  ...
  public int getSampleWidth()
  {
    ...
    try
    {
      result = Integer.parseInt( this.sampleWidth.getText() );
    }
    catch ( NumberFormatException exception )
    {
      result = 1;
  ...
  /**
   * @see nl.lxtreme.ols.util.swing.Configurable#readPreferences(nl.lxtreme.ols.util.swing.UserSettings)
   */
  @Override
  ...
  /**
   * @see nl.lxtreme.ols.util.swing.Configurable#writePreferences(nl.lxtreme.ols.util.swing.UserSettings)
   */
  @Override
