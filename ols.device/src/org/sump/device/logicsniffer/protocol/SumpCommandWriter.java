...
public class SumpCommandWriter implements SumpProtocolConstants, Closeable
{
  ...
  protected final LogicSnifferConfigImpl config;
   ...
   */
  public SumpCommandWriter( final LogicSnifferConfigImpl aConfiguration, final DataOutputStream aOutputStream )
  {
  ...
  private static int determineRleMode()
  {
    ...
    try
    {
      mode = Integer.parseInt( System.getProperty( "nl.lxtreme.ols.rle.mode", "1" ) );
    }
  ...
  private int configureTriggers() throws IOException
  {
    ...
    else
    {
      ...
      sendCommand( SETTRIGCFG, LogicSnifferConfigImpl.TRIGGER_CAPTURE );
