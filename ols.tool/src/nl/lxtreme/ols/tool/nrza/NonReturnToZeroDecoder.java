...
public class NonReturnToZeroDecoder implements Tool<AcquisitionData>
{
   ...
   */
  @Override
  public ToolTask<AcquisitionData> createToolTask( ToolContext aContext, ToolProgressListener aProgressListener )
  {
    return new NonReturnToZeroDecoderTask( aContext, aProgressListener );
  }
